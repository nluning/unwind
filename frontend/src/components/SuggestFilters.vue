<template>
  <div
    ref="filterRef"
    class="fixed top-[18px] left-[22px] z-20"
  >
    <button
      class="uw-menu-btn"
      :style="
    ...
    <div
      v-if="open"
      class="absolute left-0 top-[calc(100%+8px)] w-72 rounded-xl py-3 px-4 overflow-hidden backdrop-blur-[8px]"
      :style="{
    ...
    >
      ...
      <section class="mt-4">
        ...
        <StressLevelPicker v-model="stressLevel" clearable />
      </section>
